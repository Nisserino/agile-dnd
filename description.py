...
class RoomDescription:
    def __init__(self):
        ...
        self.description = ['the walls and floor are covered in blood',  'A light flickers from a chandelier',
                            ...
                            "there's a deep disturbing well in the middle of the room", "the room is pitch-black",
                            'a fight between knights and orcs appear to have taken place in here',
        ...
        self.senses = ['the silence is deafening', 'its exceedingly dark and gloomy',
